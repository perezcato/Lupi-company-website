export default class Particle {
    constructor(canvas, progress) {
        ...
        this.x = window.screen.width / 2 + (Math.random() * 200 - Math.random() * 200);
        this.y = window.screen.height / 2 + (Math.random() * 200 - Math.random() * 200);
        this.s = Math.random();
        this.a = 0;
        this.w = window.screen.width;
        this.h = window.screen.height;
        this.radius = random > 0.2 ? Math.random() : Math.random() * 3;
